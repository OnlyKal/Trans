    ...
    <div id="main" class="flex justify-center  h-full bg-gray-200 shadow-xl">
                       <div  id="menu" class="bg-white w-full flex h-12 items-center justify-center">
                              <div class="bg-blue-400 hover:bg-blue-500 text-white py-1 px-5 flex justify-center items-center text-sm rounded mx-3 cursor-pointer">New user</div>     
                       </div>
                        ...
                        <!-- <div id="login" class="flex flex-col h-full p-6 shadow-xl  bg-white rounded-xl items-center">                    
                            ...
                            <div class="bg-blue-400 w-full flex items-center justify-center p-2 mt-5 hover:bg-blue-500 cursor-pointer font-bold text-white rounded">
                                Connexion
                            </div>                           
                        </div>
